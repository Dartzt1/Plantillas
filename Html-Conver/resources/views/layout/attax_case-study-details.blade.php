...
<!-- Mirrored from gramentheme.com/html/attax/case-study-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:02 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>@yield('study-details')</title>
...
<body class='bg-light'>
    ...
    <!-- project area start -->
    <div id="case-study-area" class="project-details bg-sky pd-bottom-90">
        <div class="container">
            <img src="attax/assets/img/bg/15.png" alt="img">
            <div class="row">
                <div class="col-lg-8 pe-xl-5">
                    <h2>Project Overview</h2>
                    <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled</p>
                    <p>Every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. wise man therefore always holds in these</p>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-12">
                    ...
                    <p>Every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. wise man therefore always holds in these matters to this principle of selection: he rejects pleasures to secure other pleasures, or else he endures pains to avoid worse </p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="call-to-action-area bg-parallax pd-top-120 pd-bottom-120" style="background-image: url('attax/assets/img/bg/16.png');">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-7 col-md-10 align-self-center">
                    <div class="section-title style-white mb-0 text-center">
                        ...
                        <h2 class="title mt-5">Caring For Your Taxes, So You Don’t Have To</h2>
                        <div class="btn-wrap">
...
<!-- Mirrored from gramentheme.com/html/attax/case-study-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:03 GMT -->
</html>