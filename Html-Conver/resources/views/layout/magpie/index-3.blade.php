...
<!-- Mirrored from gramentheme.com/html/magpie/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:42:46 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="home-2">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/42.png" alt="img">
                    ...
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/43.png" alt="img">
                ...
                <div class="col-lg-3">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/44.png" alt="img">
                    ...
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/45.png" alt="img">
        ...
        <div class="container">
            ...
            <div class="trending-slider dots-style-base nav-right-top owl-carousel">
                <div class="item">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/46.png" alt="img">
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="magpie/assets/img/post/47.png" alt="img">
    ...
    <div class="add-area">
        <div class="container">
            <div class="thumb">
                <img src="magpie/assets/img/add/3.png" alt="img">
            </div>
        </div>
    </div>
    <!-- add area end -->
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="single-post-wrap border-bottom pb-3">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/48.png" alt="img">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="single-post-wrap border-bottom pb-3">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/49.png" alt="img">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="single-post-wrap border-bottom pb-3">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/50.png" alt="img">
                            <a class="tag-base tag-blue" href="cat-fashion.html">Business</a>
                        </div>
                        <div class="details">
                            <div class="post-meta-single mb-1">
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="single-post-slider nav-style-base nav-right-top owl-carousel">
                        <div class="item">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="magpie/assets/img/post/40.png" alt="img">
                                </div>
                                <div class="details">
                                    <div class="post-meta-single mb-1">
                                        <ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="add-thumb mb-4">
                        <img src="magpie/assets/img/add/4.png" alt="img">
                    </div>
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/41.png" alt="img">
                        </div>
                        <div class="details">
                            <a class="tag-base tag-blue mb-3" href="cat-tech.html">Tech</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/51.png" alt="img">
                        </div>
                        <div class="details">
                            <div class="post-meta-single mb-1">
                                <ul>
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/52.png" alt="img">
                        </div>
                        <div class="details">
                            <div class="post-meta-single mb-1">
                                <ul>
    ...
    <!-- video area start -->
    <div class="video-area bg-half-black pd-bottom-25">
        <div class="container">
            <div class="section-title style-two">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-post-wrap style-box-border">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/53.png" alt="img">
                ...
                <div class="col-lg-6">
                    <div class="single-post-wrap style-box-border">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/54.png" alt="img">
                            <a class="video-play-btn play-btn-medium play-btn-white" href="https://www.youtube.com/embed/Wimkqo8gDZ0" data-effect="mfp-zoom-in"><i class="fa fa-play"></i></a>
                        </div>
                        <div class="details">
                            <div class="post-meta-single mb-2">
                            ...
                            <h6 class="title mb-2"><a href="blog-details.html">Research Fast UX An Easier Speed Up The</a></h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-post-wrap style-white">
                        ...
                        <div class="details">
                            <h6 class="title mb-2"><a href="blog-details.html">Maluma UX Research An Easier Speed Up The</a></h6>
                            <div class="post-meta-single">
                                <ul>
                                    <li><i class="fa fa-clock-o"></i> April 7, 2021</li>
                                </ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-post-wrap style-white">
                        ...
                        <div class="details">
                            <h6 class="title mb-2"><a href="blog-details.html">Balmain Research An Easier Speed Up The</a></h6>
                            <div class="post-meta-single">
                                <ul>
                                    <li><i class="fa fa-clock-o"></i> April 7, 2021</li>
                                </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="magpie/assets/img/post/59.png" alt="img">
                        </div>
                        <div class="details">
                            <div class="post-meta-single mb-1">
                                <ul>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="magpie/assets/img/post/60.png" alt="img">
                                </div>
                                <div class="details">
                                    <div class="post-meta-single mb-1">
                                        <ul>
                        ...
                        <div class="col-md-6">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="magpie/assets/img/post/61.png" alt="img">
                                </div>
                                <div class="details">
                                    <div class="post-meta-single mb-1">
                                        <ul>
                ...
                <div class="col-lg-6">
                    <div class="single-post-slider nav-style-base nav-right-top owl-carousel">
                        <div class="item">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="magpie/assets/img/post/62.png" alt="img">
                                </div>
                                <div class="details">
                                    <div class="post-meta-single mb-1">
                                        <ul>
                        ...
                        <div class="item">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="magpie/assets/img/post/63.png" alt="img">
                                </div>
                                <div class="details">
                                    <div class="post-meta-single mb-1">
                                        <ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-post-wrap style-overlay-visible">
                        ...
                        <div class="details">
                            <div class="post-meta-single mb-3">
                                <ul>
                                    <li><a class="tag-base tag-purple" href="cat-lifeStyle-2.html">LifeStyle</a></li>
                                </ul>
                            </div>
...
<!-- Mirrored from gramentheme.com/html/magpie/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:43:02 GMT -->
</html>