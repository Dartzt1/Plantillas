...
<!-- Mirrored from gramentheme.com/html/attax/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:06 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>@yield('blog_Details')</title>
...
<body class='bg-light2'>
    ...
    <div class="blog-details-area pd-top-120 pd-bottom-120">
        <div class="container">
            ...
            <div class="author-meta">
                ...
                <p><span>Ashton Porter . </span>  January 19, 2023 . 02 Comments</p>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    <div class="blog-details-page-content">
                        <div class="single-blog-inner">
                            <div class="thumb">
                                <img src="attax/assets/img/blog/09.png" alt="img">
                            </div>
                            <div class="details">
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, </p>
                                <p>making this the first true generator on the Internet. It uses a dictionary of over words, combined with a handful model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
                                <blockquote>
                                    <img src="attax/assets/img/icon/7.png" alt="img">
                                    <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est,</p>
                                    <a href="#">David Kingston</a>
                                </blockquote>
                                <p>making this the first true generator on the Internet. It uses a dictionary of over words, combined with a handful model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
                                <img class="mt-4" src="attax/assets/img/blog/10.png" alt="img">
                                <h4 class="mt-5">Make Yourself Accountable</h4>
                                <p>I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is who loves or pursues or desires to obtain pain of itself, </p>
                                <div class="tag-and-share">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-3 mt-sm-0 text-sm-end align-self-center">
                            ...
                            <ul class="comment-list">
                                    ...
                                    <article id="div-comment-12" class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img class="avatar" alt="" src="attax/assets/img/team/1.png"/>
                                                Jonson Makie                
                                            </div>
                                        </footer>
                                        <div class="comment-content">
                                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>
                                        </div> 
                                        <div class="date">
                                            <a rel="nofollow" class="comment-reply-link" href="#">January 19, 2023</a>
                                        </div> 
                                        <div class="reply">
                                ...
                                <li class="comment">
                                    <article id="div-comment-12" class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img class="avatar" alt="" src="attax/assets/img/team/2.png"/>
                                                Willam Jone               
                                            </div>
                                        </footer>
                                        <div class="comment-content">
                        ...
                        <form class="blog-comment-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-black border-radius">Post Comment</button>
                                </div>
                            </div>
                        </form> 
                    </div>
                    ...
                    <div class="td-sidebar">
                        ...
                        <div class="widget widget_catagory">
                            ...
                            <ul class="catagory-items">
                                <li><a href="blog.html"><i class="fa fa-angle-double-right"></i> Investment</a></li>
                                <li><a href="blog.html"><i class="fa fa-angle-double-right"></i> Taxation</a></li>
                                <li><a href="blog.html"><i class="fa fa-angle-double-right"></i> Insight</a></li>
                                <li><a href="blog.html"><i class="fa fa-angle-double-right"></i> Financial</a></li>
                                <li><a href="blog.html"><i class="fa fa-angle-double-right"></i> Strategy</a></li>
                            </ul>
                        </div>                  
                        <div class="widget widget-recent-post">                            
                            ...
                            <ul>
                                <li>
                                    <div class="media">
                                        <div class="media-left">
                                            <img src="attax/assets/img/widget/1.png" alt="blog">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="post-info">January 19, 2023</div> 
                                            <h6 class="title"><a href="blog-details.html">Social Media For Promote Business.</a></h6>                    
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="media">
                                        <div class="media-left">
                                            <img src="attax/assets/img/widget/2.png" alt="blog">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="post-info">January 19, 2023</div>  
                                            <h6 class="title">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-left">
                                            <img src="attax/assets/img/widget/3.png" alt="blog">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="post-info">January 19, 2023</span></div>  
                                            <h6 class="title"><a href="blog-details.html">Condtum Integer urna at faucibus</a>
                                            </h6>                    
                                        </div>
                                    </div>
                                </li>
    ...
    <div class="instagram-area pd-bottom-120 pd-top-120" style="background-image: url('attax/assets/img/bg/11.png');">
        <div class="container">
...
<!-- Mirrored from gramentheme.com/html/attax/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:08 GMT -->
</html>