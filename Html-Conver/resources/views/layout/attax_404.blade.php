...
<!-- Mirrored from gramentheme.com/html/attax/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:03 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class='bg-light'>
    ...
    <!-- banner start -->
    <div class="error-area pd-bottom-120 bg-relative text-center">
        <img class="left_image_bounce position-bottom-left" src="attax/assets/img/about/7.png" alt="img">
        <img class="left_image_bounce position-center-right" src="attax/assets/img/about/9.png" alt="img">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <h2>404</h2>
                    <h3>We are sorry. But the page you are looking for cannot be found.</h3>
                    <a class="btn btn-black border-radius" href="#">Back To Homepage</a>
                </div>
            </div>
        </div>
    </div>
