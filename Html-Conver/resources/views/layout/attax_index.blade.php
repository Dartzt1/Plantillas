...
<!-- Mirrored from gramentheme.com/html/attax/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:40:58 GMT -->
...
<body class='bg-light'>
                ...
                <ul class="navbar-nav menu-open text-lg-end">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="attax_404.blade.php">404</a></li>
    ...
    <div id="team-area" class="team-area bg-relative pd-top-110 pd-bottom-90" style="background-image: url('attax/assets/img/bg/3.png');">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-team-inner text-center">
                        <img class="hover-img" src="attax/assets/img/about/12.png" alt="img">
                        <div class="thumb">
                            <img src="attax/assets/img/team/5.png" alt="img">
                        </div>
                        <div class="details">
                            <h4><a href="team-details.html">Alextina Ditarson</a></h4>
                            <p>Senior Tax Advisor</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-team-inner text-center">
                        <img class="hover-img" src="attax/assets/img/about/12.png" alt="img">
                        <div class="thumb">
                            <img src="attax/assets/img/team/6.png" alt="img">
                        </div>
                        <div class="details">
                            <h4><a href="team-details.html">Wilton Ditarson</a></h4>
                            <p>Senior Tax Advisor</p>
                            <div class="social">
                                <a href="#"><i class="fab fa-facebook"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-team-inner text-center">
                        <img class="hover-img" src="attax/assets/img/about/12.png" alt="img">
                        <div class="thumb">
                            <img src="attax/assets/img/team/7.png" alt="img">
                        </div>
                        <div class="details">
                            <h4><a href="team-details.html">Vane Ditarson</a></h4>
                            <p>Senior Tax Advisor</p>
                            <div class="social">
                                <a href="#"><i class="fab fa-facebook"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-team-inner text-center">
                        <img class="hover-img" src="attax/assets/img/about/12.png" alt="img">
                        <div class="thumb">
                            <img src="attax/assets/img/team/8.png" alt="img">
                        </div>
                        <div class="details">
                            <h4><a href="team-details.html">Etina Frarson</a></h4>
                            <p>Senior Tax Advisor</p>
                            <div class="social">
                                <a href="#"><i class="fab fa-facebook"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
    ...
    <div class="call-to-action-area bg-relative pd-top-110 pd-bottom-120">
        <img class="top_image_bounce position-top-right" src="attax/assets/img/about/9.png" alt="img">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-7 col-md-10 align-self-center">
                    <div class="section-title mb-0 text-center">
                        <h2 class="title">Join us & shine the world with you skill</h2>
                        <h5 class="small-title">Our nearly <span>7,000+</span> committed staff members are ready to help.</h5>
                        <div class="btn-wrap">
                            <a class="btn btn-black border-radius" href="about.html">Join Now !</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="quote-area pd-top-120 pd-bottom-120">
        <div class="container">
            <div class="row">
...
<!-- Mirrored from gramentheme.com/html/attax/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:01 GMT -->
</html>