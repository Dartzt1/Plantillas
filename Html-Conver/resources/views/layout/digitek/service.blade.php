...
<!-- Mirrored from gramentheme.com/html/digitek/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:42:10 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="breadcrumb__area">
         <img class="breadcrumb__shape-1" src="digitek/assets/img/shape/breadcrum-1.png.png" alt="image not found">
         <img class="breadcrumb__shape-2" src="digitek/assets/img/shape/breadcrum-1.png.png" alt="image not found">
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
                     ...
                     <div class="breadcrumb__menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                           <ul class="trail-items">
                              <li class="trail-item trail-begin"><span><a href="index-2.html">Home</a></span></li>
                           ...
                           <div class="features__traffic">
                              ...
                              <div class="icon">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="18.953" height="11.624" viewBox="0 0 18.953 11.624">
                                    <g id="trending-uphvc3dv" transform="translate(1.414 1.414)">
                                       <path id="Path_47xcx3" data-name="Path 473" d="M17.125,6l-6.963,6.963L6.5,9.3,1,14.8" transform="translate(-1 -6)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                       <path id="Path_474cxc" data-name="Path 474" d="M17,6h4.4v4.4" transform="translate(-5.273 -6)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                    </g>
                                    </svg>                            
                              </div>
                           </div>
                              ...
                              <div class="icon">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="21.397" height="12.957" viewBox="0 0 21.397 12.957">
                                    <g id="trending-up" transform="translate(1.414 1.414)">
                                      <path id="Path_473bvb" data-name="Path 473" d="M19.569,6,11.55,14.018,7.33,9.8,1,16.128" transform="translate(-1 -6)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                      <path id="Path_474" data-name="Path 474" d="M17,6h5.064v5.064" transform="translate(-3.496 -6)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                    </g>
                                  </svg>                                                                                              
                              </div>
                           </div>
                     ...
                     <div class="approach__features s-2">
                        <div class="approach__features-item">
                           <div class="approach__arrow">
                              <img src="digitek/assets/img/svg/arrow-2.svg" alt="">                            
                           </div>
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="boost__thumb-wrapper mb-60">
                     <div class="boost__thumb w-img p-relative">
                        <img src="digitek/assets/img/boost/boost-01.png" alt="image not found">
                     ...
                     <div class="boost__shape-2">
                        <svg id="Group_27289" data-name="Group 27289" xmlns="http://www.w3.org/2000/svg" width="25.594" height="19.655" viewBox="0 0 25.594 19.655">
                           <path id="Path_26014" data-name="Path 26014" d="M321.713,46.082l-25.594,3.962,0,.008.163,1.6a23.645,23.645,0,0,0,7.662,14.089Z" transform="translate(-296.119 -46.082)" fill="#f8d458"></path>
                         </svg>                         
                     </div>
                     ...
                     <div class="boost__shape-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="44.495" height="44.279" viewBox="0 0 44.495 44.279">
                           <path id="Path_26017" data-name="Path 26017" d="M437.625,75.1a11.863,11.863,0,1,1-13.383,10.112l-10.288-1.433a22.245,22.245,0,1,0,25.1-18.964Z" transform="translate(-413.738 -64.809)" fill="#425fec"></path>
                         </svg>
                     </div>
                  </div>
            </div>
      ...
      <!-- Cta area start -->
      <div class="cta__area pb-120">
         <div class="container">
            <div class="cta__main-wrappper">
               <div class="row wow fadeInUp" data-wow-delay=".3s">
                  <div class="col-xl-12">
                     <div class="cta__content-box text-center">
                        <div class="cta__icon">
                           <img src="digitek/assets/img/svg/cta.svg" alt="">
                        </div>
                        <div class="cta__title mb-60">
                           Subscribe to get information, latest news
                           and other interesting offers
                        </div>
                        <div class="cta__filter">
      ...
      <!-- Footer area start -->
      <footer>
         <section class="footer__border grey__bg pb-60">
            <div class="container">
               <div class="row">
...
<!-- Mirrored from gramentheme.com/html/digitek/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:42:11 GMT -->
</html>
