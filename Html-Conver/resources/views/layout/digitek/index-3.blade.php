...
<!-- Mirrored from gramentheme.com/html/digitek/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:47 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <!-- Hero area stat -->
      <section class="hero__area hero__hight d-flex align-items-center include__bg p-relative" data-background="digitek/assets/img/shape/c.png">
         <div class="hero__cercle">
            <img src="digitek/assets/img/shape/cercle.png" alt="image not found">
         </div>
         <div class="container">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6">
                     <div class="hero__thumb-wrapper-2 mb-60">
                        <div class="hero__thumb-2 w-img">
                           <img src="digitek/assets/img/hero/hero-thumb-2.png" alt="image not found">
                        </div>
                        <div class="hero__shape-7">
                           <img src="digitek/assets/img/shape/hero-shape-5.png" alt="image not found">
                        </div>
                        <div class="hero__shape-8">
                           <img src="digitek/assets/img/shape/hero-shape-6.png" alt="image not found">
                        </div>
                        <div class="hero__regtangle">
                           <img src="digitek/assets/img/shape/rectangle-3.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <div class="about__area grey-bg z-index-11 p-relative pt-120 pb-60">
         <div class="about__shape-1">
            <img src="digitek/assets/img/shape/about-shape-1.png" alt="image not found">
         </div>
         <div class="about__shape-2">
            <img src="digitek/assets/img/shape/about-shape-2.png" alt="image not found">
         </div>
         <div class="about__shape-3">
            <img src="digitek/assets/img/shape/rectangle-3.png" alt="image not found">
         </div>
         <div class="about__shape-4">
            <img src="digitek/assets/img/shape/rectangle-4.png" alt="image not found">
         </div>
         <div class="container">
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="about__thumb-wrapper mb-60">
                     <div class="about__thumb w-img">
                        <img src="digitek/assets/img/about/about-thumb.png" alt="image not found">
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
      ...
      <div class="cta__area p-relative pt-120 pb-6">
         ...
         <div class="container">
            <div class="cta__inner navy-bg include__bg" data-background="digitek/assets/img/shape/cta-shape.png">
               <div class="row align-items-center">
                  <div class="col-xl-5">
      ...
      <!-- Service area start -->
      <div class="service__area service__bg z-index-1 pt-120 pb-90" data-background="digitek/assets/img/shape/service-pattren.png">
         <div class="container">
            <div class="row">
               <div class="col-12">
            ...
            <div class="row wow fadeInUp" data-wow-delay=".3s">
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="service__item mb-30">
                     <div class="service__thumb include__bg" data-background="digitek/assets/img/service/service-1.jpg" style="background-image: url(_assets/img/service/service-1.html);"></div>
            ...
            <div class="row wow fadeInUp" data-wow-delay=".3s">
               <div class="col-xl-6 col-lg-6">
                  <div class="recent__thumb mb-30">
                     <img src="digitek/assets/img/recent/01.jpg" alt="image not found">
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
                  <div class="recent__thumb mb-30">
                     <img src="digitek/assets/img/recent/02.jpg" alt="image not found">
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="features__thumb-wrapper mb-60">
                     <div class="features__thumb">
                        <img src="digitek/assets/img/features/02.png" alt="image not found">
                     </div>
                  ...
                  <div class="swiper team__active">
                     <div class="swiper-wrapper">
                        <div class="swiper-slide">
                           <div class="team__item">
                              <div class="team__thumb">
                                 <img src="digitek/assets/img/team/01.jpg" alt="image not found">
                              </div>
                        ...
                        <div class="swiper-slide">
                           <div class="team__item">
                              <div class="team__thumb">
                                 <img src="digitek/assets/img/team/02.jpg" alt="image not found">
                              </div>
                              <div class="team__content">
                                 <h3><a href="team-details.html">Adriano Savedra</a></h3>
                                 <p>SEO Strategies</p>
                        ...
                        <div class="swiper-slide">
                           <div class="team__item">
                              <div class="team__thumb">
                                 <img src="digitek/assets/img/team/03.jpg" alt="image not found">
                              </div>
                              <div class="team__content">
                                 <h3><a href="team-details.html">Adriano Savedra</a></h3>
                                 <p>SEO Strategies</p>
      ...
      <!-- Feedback area start -->
      <section class="feedback__area feedback__overlay p-relative" data-background="digitek/assets/img/feedback/feedback-bg.jpg">
                           ...
                           <div class="col-xxl-11 col-xl-10 col-xl-8 col-lg-10 col-md-11">
                              <div class="testimonial__slider-2">
                                 <div class="feedbacK__shape">
                                    <img src="digitek/assets/img/shape/feedback-shape.png" alt="image not found">
                                 </div>
                                 <div class="row">
                                    <div class="col-xxl-8 col-lg-9 col-md-8 col-sm-10">
                                       <div class="testimonial__slider-nav">
                                          <div class="testimonial__slider-thumb-nav">
                                             <img src="digitek/assets/img/feedback/nav/01.png" alt="">
                                          </div>
                                          <div class="testimonial__slider-thumb-nav">
                                             <img src="digitek/assets/img/feedback/nav/02.png" alt="">
                                          </div>
                                          <div class="testimonial__slider-thumb-nav">
                                             <img src="digitek/assets/img/feedback/nav/03.png" alt="">
                                          </div>
                                          <div class="testimonial__slider-thumb-nav">
                                             <img src="digitek/assets/img/feedback/nav/01.png" alt="">
                                          </div>
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="blog__thumb-wrapper mb-30">
                     <div class="blog__thumb w-img">
                        <img src="digitek/assets/img/blog/blog-3.jpg" alt="image not found">
                     </div>
                  </div>
               </div>
            </div>
...
<!-- Mirrored from gramentheme.com/html/digitek/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2023 01:41:58 GMT -->
</html>
